...
<html>
    ...
    <head>
        ...
        <title>Student Profile | Kokawala Central Collage</title>
        <meta charset="UTF-8"/>
                ...
                <div class="offset-3 animation offset-lg-3" style="border-radius: 20px; width: 50%;">
                    <div class="row">
                        <div class="col-12 center badge">
                            <br/>
                            <img src="student.png" style="width: 30%; border-radius: 10px;"/>
                            <br/>
                        </div>
                        <div class="col-12 center text-center">
                            <br/>
                            <span class="text-secondary fw-bold"><?php echo $_SESSION["student"]["email"]; ?></span>
                            <br/><br/>
                        </div>
                        <div class="col-12 border" style="border-radius: 20px;">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" value="<?php echo $_SESSION["student"]["name"]; ?>" class="form-control"/>
                                </div>
                                <div class="col-12">
                                    <br/>
                                    <label class="fw-bold">Password</label>
                                    <input type="password" value="<?php echo $_SESSION["student"]["password"]; ?>" class="form-control"/>
                                </div>
                                <div class="col-12">
                                    <br/>
                                    <label class="fw-bold">Grade</label>
                                    <input type="text" value="<?php echo $_SESSION["student"]["grade"]; ?>" class="form-control"/>
                                </div>
                                <div class="col-12">
                                    <br/>
                                    <label class="fw-bold">Email</label>
                                    <input type="email" value="<?php echo $_SESSION["student"]["email"]; ?>" class="form-control"/>
                                </div>
                                <div class="col-12">
                                    <br/>
                                    <label class="fw-bold">Mobile Number</label>
                                    <input type="text" value="<?php echo $_SESSION["student"]["mobile_number"]; ?>" class="form-control"/>
                                </div>
                                ...
                                <div class="col-12">
                                    <br/>
                                    <button class="btn btn-primary col-12" onclick="backtoSDashboard();">Back to Dashboard</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal" id="myModal">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h3 class="modal-title">Update Student Profile</h3>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success" onclick="sSaveChanges();">Save Changes</button>
