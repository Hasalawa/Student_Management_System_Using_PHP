...
<html>
    ...
    <head>
        ...
        <title>Admmin Login | Kokawala Central Collage</title>
        <meta charset="UTF-8"/>
            ...
            <div class="container-fluid">
                ...
                <div class="col-12 col-lg-6 offset-lg-3">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12">
                            <br/>
                            <h1 class="animation text-center" style="text-shadow: -1px 0 black, 2px 0 black, 0 -1px black;">Admin Login</h1>
                            <hr class="animation"/>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 animation badge">
                                <br/><br/>
                                <img src="admin.png" style="width: 25%;"/>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="email" class="form-control animation" id="email"/>
                            &nbsp;
                        </div>

                        <div class="col-12">
                            <p class="animation" style="font-family: 'Times New Roman', Times, serif; font-weight: bold;">Password</p>
                            <input type="password" class="form-control animation" id="password"/>
                            &nbsp;
                        </div>

                        <div class="col-12 col-lg-6 d-grid">
                            <button type="button" class="btn btn-success animation" data-bs-toggle="modal" data-bs-target="#myModal" onclick="adminProcess();">Log In</button>
                        </div>
