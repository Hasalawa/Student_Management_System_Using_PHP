...
<html>
    ...
    <head>
        ...
        <title>Teacher Profile | Kokawala Central Collage</title>
        <meta charset="UTF-8"/>
                ...
                <div class="offset-3 animation offset-lg-3" style="border-radius: 20px; width: 50%;">
                    <div class="row">
                        <div class="col-12 center badge">
                            <br/>
                            <img src="teacher.png" style="width: 30%; border-radius: 10px;"/>
                            <br/>
                        </div>
                        <div class="col-12 center text-center">
                            <br/>
                            <span class="text-secondary fw-bold"><?php echo $_SESSION["teacher"]["email"]; ?></span>
                            <br/><br/>
                        </div>
                        <div class="col-12 border" style="border-radius: 20px;">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" value="<?php echo $_SESSION["teacher"]["name"]; ?>" class="form-control"/>
                                </div>
                                <div class="col-12">
                                    <br/>
                                    <label class="fw-bold">Password</label>
                                    <input type="password" value="<?php echo $_SESSION["teacher"]["password"]; ?>" class="form-control"/>
                                </div>
                                <div class="col-12">
                                    <br/>
                                    <label class="fw-bold">Grade</label>
                                    <input type="text" value="<?php echo $_SESSION["teacher"]["grade"]; ?>" class="form-control"/>
                                </div>
                                <div class="col-12">
                                    <br/>
                                    <label class="fw-bold">Subject</label>
                                    <input type="text" value="<?php echo $_SESSION["teacher"]["subject"]; ?>" class="form-control"/>
                                </div>
                                <div class="col-12">
                                    <br/>
                                    <label class="fw-bold">Email</label>
                                    <input type="email" value="<?php echo $_SESSION["teacher"]["email"]; ?>" class="form-control"/>
                                </div>
                                <div class="col-12">
                                    <br/>
                                    <label class="fw-bold">Mobile Number</label>
                                    <input type="text" value="<?php echo $_SESSION["teacher"]["mobile_number"]; ?>" class="form-control"/>
                                </div>
                                ...
                                <div class="col-12">
                                    <br/>
                                    <button class="btn btn-primary col-12" onclick="backtoTDashboard();">Back to Dashboard</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal" id="myModal">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h3 class="modal-title">Update Teacher Profile</h3>
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" id="tMobile"/>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success" onclick="tSaveChanges();">Save Changes</button>
