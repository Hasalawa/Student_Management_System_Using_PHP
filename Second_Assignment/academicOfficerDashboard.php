...
<html>
    ...
    <head>
        ...
        <title>Academic Officer Dashboard | Kokawala Central Collage</title>
        <meta charset="UTF-8"/>
                        ...
                        <div class="align-items-start list-group-item-secondary col-12">
                            <div class="row g-1 text-center">
                                ...
                                <div class="text-center col-12 col-lg-12 text-center mt-2">
                                    <img src="acadamic_officer.png" class="animation" style="width: 50%;"/>
                                </div>
                                <div>
                                    <h6 class="animation" style="font-weight: bold; font-family: monospace;">Welcome <?php echo $_SESSION["academic"]["name"]; ?>!</h6>
                                    <hr class="animation"/>
                                </div>
                                <div class="col-lg-12 animation">

                                    <br/>
                                    <button class="col-12 btn btn-primary animation" onclick="aM();">Assignment Marks</button>
                                    <br/><br/>
                                    <button class="col-12 btn btn-primary animation" onclick="academicOfficerProfile();">Profile</button>
                                    <br/><br/>
                                    <button class="col-12 btn btn-primary animation" onclick="rs();">Register Students</button>
                                    <br/><br/>
