...
<html>
    ...
    <head>
        ...
        <title>Teacher Dashboard | Kokawala Central Collage</title>
        <meta charset="UTF-8"/>
                        ...
                        <div class="align-items-start list-group-item-secondary col-12">
                            <div class="row g-1 text-center">
                                ...
                                <div class="text-center col-12 col-lg-12 text-center mt-2">
                                    <img src="teacher.png" class="animation" style="width: 50%;"/>
                                </div>
                                <div>
                                    <h6 class="animation" style="font-weight: bold; font-family: monospace;">Welcome <?php echo $_SESSION["teacher"]["name"]; ?>!</h6>
                                    <hr class="animation"/>
                                </div>
                                <div class="col-lg-12 animation">
                                    <button class="col-12 btn btn-primary animation" onclick="tline();">Timeline</button>
                                    <br/><br/>
                                    <button class="col-12 btn btn-primary animation" onclick="teacherProfile();">Profile</button>
                                    <br/><br/>
                                    <button class="col-12 btn btn-primary animation" onclick="vsa();">View Submited Answer Sheets</button>
                                    <br/><br/>
                                ...
                                <div class="col-6 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 text-center list-group-item-success border border-1 border-dark rounded animation">
                                            ...
                                            <br/>
                                            <span class="fs-5 bold">Students</span>
                                            <br/>
