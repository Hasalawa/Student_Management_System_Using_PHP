...
if(empty($receiver)){
    ...
    $stmt = $db->prepare("INSERT INTO `verification_codes_academic` (`user_id`, `code`) VALUES (?, ?)");
    ...
    $q = "SELECT * FROM `acadamic_officer` WHERE `email`='" . $receiver . "'";
